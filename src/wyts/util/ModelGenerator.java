...
import wyts.lang.DefaultInterpretation.Config;

public class ModelGenerator {
private final ArrayList<Value> model;
	
	private DefaultInterpretation(ArrayList<Value> values) {
		this.model = values;
	}
	...
	public static DefaultInterpretation generate(Config config) {
		...
		return new DefaultInterpretation(model);
	}
	...
	public static void main(String[] args) {
		...
		DefaultInterpretation model = generate(DEFAULT_CONFIG);
