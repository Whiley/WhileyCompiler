 ...
 *
 */
public final class WhileyFile extends AbstractCompilationUnit<WhileyFile> {
	...
	public static final int STMT_assert = STMT_mask + 2;
	public static final int STMT_assign = STMT_mask + 3;
	public static final int STMT_assume = STMT_mask + 4;
	public static final int STMT_debug = STMT_mask + 5;
	public static final int STMT_skip = STMT_mask + 6;
	public static final int STMT_break = STMT_mask + 7;
	public static final int STMT_continue = STMT_mask + 8;
	public static final int STMT_dowhile = STMT_mask + 9;
	public static final int STMT_fail = STMT_mask + 10;
	public static final int STMT_for = STMT_mask + 11;
	public static final int STMT_foreach = STMT_mask + 12;
	public static final int STMT_if = STMT_mask + 13;
	public static final int STMT_ifelse = STMT_mask + 14;
	public static final int STMT_return = STMT_mask + 15;
	public static final int STMT_switch = STMT_mask + 16;
	public static final int STMT_while = STMT_mask + 17;
	...
	// substitution.
	public static final int EXPR_arrgen = EXPR_mask + 64;
	public static final int EXPR_arrinit = EXPR_mask + 65;
	public static final int EXPR_recinit = EXPR_mask + 66;
	...
	public static interface Declaration extends CompilationUnit.Declaration {
		...
		public static abstract class FunctionOrMethodOrProperty extends Named {
			...
			public abstract WhileyFile.Type.FunctionOrMethodOrProperty getSignatureType();
		}
		...
		public static class Function extends FunctionOrMethodOrProperty {
			...
			@Override
			public WhileyFile.Type.Function getSignatureType() {
				// FIXME: a better solution would be to have an actual signature
				// object
				Tuple<WhileyFile.Type> projectedParameters = getParameters().project(0, WhileyFile.Type.class);
				Tuple<WhileyFile.Type> projectedReturns = getReturns().project(0, WhileyFile.Type.class);
		...
		public static class Method extends FunctionOrMethodOrProperty {
			...
			@Override
			public WhileyFile.Type.Method getSignatureType() {
				// FIXME: a better solution would be to have an actual signature
				// object
				Tuple<WhileyFile.Type> projectedParameters = getParameters().project(0, WhileyFile.Type.class);
				Tuple<WhileyFile.Type> projectedReturns = getReturns().project(0, WhileyFile.Type.class);
				// FIXME: lifetime arguments
				return new WhileyFile.Type.Method(projectedParameters, projectedReturns, null, null);
			}
		...
		public static class Property extends FunctionOrMethodOrProperty {
			...
			@Override
			public WhileyFile.Type.Property getSignatureType() {
				// FIXME: a better solution would be to have an actual signature
				// object
				Tuple<WhileyFile.Type> projectedParameters = getParameters().project(0, WhileyFile.Type.class);
				Tuple<WhileyFile.Type> projectedReturns = getReturns().project(0, WhileyFile.Type.class);
	...
	public interface Type extends SyntacticItem {
		 ...
		 * contextual lifetime arguments, and may themselves declare lifetime
		 * arguments.
		 *
		 * @author David J. Pearce
		 *
		...
		public static class Method extends FunctionOrMethodOrProperty implements Type {
			...
			public Method(Tuple<Type> parameters, Tuple<Type> returns, Tuple<Identifier> contextLifetimes,
				...
				super(TYPE_meth, new SyntacticItem[] { parameters, returns, contextLifetimes, lifetimeParameters });
			}
