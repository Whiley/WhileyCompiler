...
import wyll.interpreter.Interpreter.CallStack;
...
public class ConcreteSemantics  {
	...
	public static RValue.Cell Cell(RValue value) {
		return new RValue.Cell((RValue) value);
	}

	public static RValue.Reference Reference(RValue.Cell value) {
	...
	public static RValue.Lambda Lambda(Decl.Method context, Interpreter.CallStack frame, Stmt body) {
	...
	public static abstract class RValue {
		...
		public final static class Bool extends RValue {
			...
			public Bool and(RValue.Bool _rhs) {
				Bool rhs = (Bool) _rhs;
				return (value && rhs.value) ? True : False;
			}

			public Bool or(RValue.Bool _rhs) {
				Bool rhs = (Bool) _rhs;
				return (value || rhs.value) ? True : False;
			}
...
//				}
			...
			public RValue.Byte and(RValue.Byte _rhs) {
				RValue.Byte rhs = (RValue.Byte) _rhs;
				return new RValue.Byte((byte) (value & rhs.value));
			}


			public RValue.Byte or(RValue.Byte _rhs) {
				RValue.Byte rhs = (RValue.Byte) _rhs;
				return new RValue.Byte((byte) (value | rhs.value));
			}


			public RValue.Byte xor(RValue.Byte _rhs) {
				RValue.Byte rhs = (RValue.Byte) _rhs;
				return new RValue.Byte((byte) (value ^ rhs.value));
			}


			public RValue.Byte shl(RValue.Int _rhs) {
				RValue.Int rhs = (RValue.Int) _rhs;
				return new RValue.Byte((byte) (value << rhs.intValue()));
			}


			public RValue.Byte shr(RValue.Int _rhs) {
				RValue.Int rhs = (RValue.Int) _rhs;
				return new RValue.Byte((byte) (value >> rhs.intValue()));
			}
		...
		public final static class Int extends RValue {
			...
			public Int add(RValue.Int _rhs) {
				RValue.Int rhs = (RValue.Int) _rhs;
				return new Int(value.add(rhs.value));
			}


			public Int subtract(RValue.Int _rhs)  {
				RValue.Int rhs = (RValue.Int) _rhs;
				return new Int(value.subtract(rhs.value));
			}


			public Int multiply(RValue.Int _rhs) {
				RValue.Int rhs = (RValue.Int) _rhs;
				return new Int(value.multiply(rhs.value));
			}


			public Int divide(RValue.Int _rhs) {
				RValue.Int rhs = (RValue.Int) _rhs;
				return new Int(value.divide(rhs.value));
			}


			public Int remainder(RValue.Int _rhs) {
				RValue.Int rhs = (RValue.Int) _rhs;
				return new Int(value.remainder(rhs.value));
			}


			public Bool lessThan(RValue.Int _rhs) {
				RValue.Int rhs = (RValue.Int) _rhs;
				return (value.compareTo(rhs.value) < 0) ? True : False;
			}


			public Bool lessThanOrEqual(RValue.Int _rhs) {
				RValue.Int rhs = (RValue.Int) _rhs;
				return (value.compareTo(rhs.value) <= 0) ? True : False;
			}
		...
		public final static class Array extends RValue {
			...
			public RValue read(RValue.Int _index) {
			...
			public RValue.Array write(RValue.Int _index, RValue value) {
				RValue.Int index = (RValue.Int)_index;
				int idx = index.value.intValue();
		...
		public final static class Record extends RValue {
			...
			public RValue.Record write(Identifier field, RValue value) {
		...
		public final static class Lambda extends RValue {
			...
			private Lambda(Decl.Method context, Interpreter.CallStack frame, Stmt body) {
