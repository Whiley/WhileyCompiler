...
public final class OptArg {
	...
	public static Map<String,Object> parseOptions(List<String> args, OptArg... options) {
		...
		HashMap<String,OptArg> soptmap = new HashMap<>();
		HashMap<String,OptArg> loptmap = new HashMap<>();
	...
	private static Object[] parseLongForm(String arg, Iterator<String> iter, Map<String, OptArg> opts) {
	...
	private static Object[] parseShortForm(String arg, Iterator<String> iter, Map<String, OptArg> opts) {
