...
echo ""
echo "public class SimpleStaticInvalidTests extends TestHarness {"
echo " public SimpleStaticInvalidTests() {"
echo "  super(\"tests/invalid/simple\",\"tests/invalid/simple\",\"sysout\");"
echo " }"
echo ""
