 ...
 */
public class SetEquals extends ConditionBinOp<Expr> implements Condition {
	public SetEquals(Expr lhs, Expr rhs, Attribute... attributes) {
		super(lhs,rhs,attributes);
	}

	public SetEquals(Expr lhs, Expr rhs, Collection<Attribute> attributes) {
		super(lhs,rhs,attributes);
	}		
	...
	public Condition substitute(Map<String,Expr> binding) {
		...
		return new SetEquals(l,r,attributes());
	}
