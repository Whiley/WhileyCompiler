 ...
 */
public final class TupleEquals extends ConditionBinOp<Expr> implements Condition {
	public TupleEquals(Expr lhs, Expr rhs, Attribute... attributes) {		
		super(lhs,rhs,attributes);		
	}

	public TupleEquals(Expr lhs, Expr rhs, Collection<Attribute> attributes) {
		super(lhs,rhs,attributes);		
	}		
	...
	public Condition substitute(Map<String,Expr> binding) {
		...
		return new TupleEquals(l,r,attributes());
	}
