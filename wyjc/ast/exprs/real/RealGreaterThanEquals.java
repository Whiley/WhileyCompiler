 ...
 */
public class RealGreaterThanEquals extends ConditionBinOp<Expr> implements Condition {
	
	public RealGreaterThanEquals(Expr lhs, Expr rhs, Attribute... attributes) {
		super(lhs,rhs,attributes);		
	}

	public RealGreaterThanEquals(Expr lhs, Expr rhs, Collection<Attribute> attributes) {
		super(lhs,rhs,attributes);
	}
	...
	public Condition substitute(Map<String,Expr> binding) {
		...
		return new RealGreaterThanEquals(l,r,attributes());
	}
	...
	public Pair<WFormula, WFormula> convertCondition(Map<String, Type> environment, ModuleLoader loader) throws ResolveError {
		...
		wenv.putAll(r.third());
		return new Pair<WFormula,WFormula>(WNumerics.greaterThanEq(l
