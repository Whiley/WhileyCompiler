 ...
 */
public class RealLessThan extends ConditionBinOp<Expr> implements Condition {
	public RealLessThan(Expr lhs, Expr rhs, Attribute... attributes) {
		super(lhs,rhs,attributes);
	}

	public RealLessThan(Expr lhs, Expr rhs, Collection<Attribute> attributes) {
		super(lhs,rhs,attributes);
	}
	...
	public Condition substitute(Map<String,Expr> binding) {
		...
		return new RealLessThan(l,r,attributes());
	}
	...
	public Triple<WFormula, WFormula, WEnvironment> convertCondition(Map<String, Type> environment, ModuleLoader loader) throws ResolveError {
		...
		wenv.addAll(r.third());
		return new Triple<WFormula, WFormula, WEnvironment>(lessThan(l
