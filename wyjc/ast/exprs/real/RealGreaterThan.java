 ...
 */
public class RealGreaterThan extends ConditionBinOp<Expr> implements Condition {
	public RealGreaterThan(Expr lhs, Expr rhs, Attribute... attributes) {
		super(lhs,rhs,attributes);
	}

	public RealGreaterThan(Expr lhs, Expr rhs, Collection<Attribute> attributes) {
		super(lhs,rhs,attributes);
	}
	...
	public Condition substitute(Map<String,Expr> binding) {
		...
		return new RealGreaterThan(l,r,attributes());
	}
	...
	public Triple<WFormula, WFormula, WEnvironment> convertCondition(Map<String, Type> environment, ModuleLoader loader) throws ResolveError {
		...
		wenv.putAll(r.third());
		return new Triple<WFormula, WFormula, WEnvironment>(WNumerics.greaterThan(l
