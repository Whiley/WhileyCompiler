 ...
 */
public class RealLessThanEquals extends ConditionBinOp<Expr> implements Condition {
    public RealLessThanEquals(Expr lhs, Expr rhs, Attribute... attributes) {
    	super(lhs,rhs,attributes);
    }

    public RealLessThanEquals(Expr lhs, Expr rhs, Collection<Attribute> attributes) {
    	super(lhs,rhs,attributes);
    }
	...
	public Condition substitute(Map<String,Expr> binding) {
		...
		return new RealLessThanEquals(l,r,attributes());
	}	
