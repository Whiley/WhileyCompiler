...
public final class Types {
	// term Not(^($4<Not(^($12<Any|Void|Bool|Int|Real|String>))|$12|Not(^($4))|Ref(^($4))|Meta(^($4))|Nominal(^([^(string),^($4)]))|Or(^({^($4)...}))|And(^({^($4)...}))|Set(^([^(bool),^({^($4)...})]))|Bag(^([^(bool),^({|^($4)...|})]))|List(^([^(bool),^([^($4)...])]))>))
	...
	// term And(^({^($9<Not(^($17<Any|Void|Bool|Int|Real|String>))|$17|Not(^($9))|Ref(^($9))|Meta(^($9))|Nominal(^([^(string),^($9)]))|Or(^({^($9)...}))|And(^({^($9)...}))|Set(^([^(bool),^({^($9)...})]))|Bag(^([^(bool),^({|^($9)...|})]))|List(^([^(bool),^([^($9)...])]))>)...}))
	...
	// term Or(^({^($9<Not(^($17<Any|Void|Bool|Int|Real|String>))|$17|Not(^($9))|Ref(^($9))|Meta(^($9))|Nominal(^([^(string),^($9)]))|Or(^({^($9)...}))|And(^({^($9)...}))|Set(^([^(bool),^({^($9)...})]))|Bag(^([^(bool),^({|^($9)...|})]))|List(^([^(bool),^([^($9)...])]))>)...}))
	...
	// term Ref(^($4<Not(^($12<Any|Void|Bool|Int|Real|String>))|$12|Not(^($4))|Ref(^($4))|Meta(^($4))|Nominal(^([^(string),^($4)]))|Or(^({^($4)...}))|And(^({^($4)...}))|Set(^([^(bool),^({^($4)...})]))|Bag(^([^(bool),^({|^($4)...|})]))|List(^([^(bool),^([^($4)...])]))>))
	...
	// term Meta(^($4<Not(^($12<Any|Void|Bool|Int|Real|String>))|$12|Not(^($4))|Ref(^($4))|Meta(^($4))|Nominal(^([^(string),^($4)]))|Or(^({^($4)...}))|And(^({^($4)...}))|Set(^([^(bool),^({^($4)...})]))|Bag(^([^(bool),^({|^($4)...|})]))|List(^([^(bool),^([^($4)...])]))>))
	...
	// term Term(^([^(string),^($10<Not(^($18<Any|Void|Bool|Int|Real|String>))|$18|Not(^($10))|Ref(^($10))|Meta(^($10))|Nominal(^([^(string),^($10)]))|Or(^({^($10)...}))|And(^({^($10)...}))|Set(^([^(bool),^({^($10)...})]))|Bag(^([^(bool),^({|^($10)...|})]))|List(^([^(bool),^([^($10)...])]))>)]))
	...
	// term Nominal(^([^(string),^($10<Not(^($18<Any|Void|Bool|Int|Real|String>))|$18|Not(^($10))|Ref(^($10))|Meta(^($10))|Nominal(^([^(string),^($10)]))|Or(^({^($10)...}))|And(^({^($10)...}))|Set(^([^(bool),^({^($10)...})]))|Bag(^([^(bool),^({|^($10)...|})]))|List(^([^(bool),^([^($10)...])]))>)]))
	...
	// term Fun(^([^($10<Not(^($18<Any|Void|Bool|Int|Real|String>))|$18|Not(^($10))|Ref(^($10))|Meta(^($10))|Nominal(^([^(string),^($10)]))|Or(^({^($10)...}))|And(^({^($10)...}))|Set(^([^(bool),^({^($10)...})]))|Bag(^([^(bool),^({|^($10)...|})]))|List(^([^(bool),^([^($10)...])]))>),^($10)]))
	...
	// term Set(^([^(bool),^({^($15<Not(^($23<Any|Void|Bool|Int|Real|String>))|$23|Not(^($15))|Ref(^($15))|Meta(^($15))|Nominal(^([^(string),^($15)]))|Or(^({^($15)...}))|And(^({^($15)...}))|Set(^([^(bool),^({^($15)...})]))|Bag(^([^(bool),^({|^($15)...|})]))|List(^([^(bool),^([^($15)...])]))>)...})]))
	...
	// term Bag(^([^(bool),^({|^($15<Not(^($23<Any|Void|Bool|Int|Real|String>))|$23|Not(^($15))|Ref(^($15))|Meta(^($15))|Nominal(^([^(string),^($15)]))|Or(^({^($15)...}))|And(^({^($15)...}))|Set(^([^(bool),^({^($15)...})]))|Bag(^([^(bool),^({|^($15)...|})]))|List(^([^(bool),^([^($15)...])]))>)...|})]))
	...
	// term List(^([^(bool),^([^($15<Not(^($23<Any|Void|Bool|Int|Real|String>))|$23|Not(^($15))|Ref(^($15))|Meta(^($15))|Nominal(^([^(string),^($15)]))|Or(^({^($15)...}))|And(^({^($15)...}))|Set(^([^(bool),^({^($15)...})]))|Bag(^([^(bool),^({|^($15)...|})]))|List(^([^(bool),^([^($15)...])]))>)...])]))
	...
	public static final Schema SCHEMA = new Schema(new Schema.Term[]{
		// Not(^($4<Not(^($12<Any|Void|Bool|Int|Real|String>))|$12|Not(^($4))|Ref(^($4))|Meta(^($4))|Nominal(^([^(string),^($4)]))|Or(^({^($4)...}))|And(^({^($4)...}))|Set(^([^(bool),^({^($4)...})]))|Bag(^([^(bool),^({|^($4)...|})]))|List(^([^(bool),^([^($4)...])]))>))
		...
		// And(^({^($9<Not(^($17<Any|Void|Bool|Int|Real|String>))|$17|Not(^($9))|Ref(^($9))|Meta(^($9))|Nominal(^([^(string),^($9)]))|Or(^({^($9)...}))|And(^({^($9)...}))|Set(^([^(bool),^({^($9)...})]))|Bag(^([^(bool),^({|^($9)...|})]))|List(^([^(bool),^([^($9)...])]))>)...}))
		Schema.Term("And",Schema.Set(true,Schema.Or(Schema.Or(Schema.Term("Not",Schema.Or(Schema.Term("Any"), Schema.Term("Void"), Schema.Term("Bool"), Schema.Term("Int"), Schema.Term("Real"), Schema.Term("String"))), Schema.Any), Schema.Term("Not",Schema.Any), Schema.Term("Ref",Schema.Any), Schema.Term("Meta",Schema.Any), Schema.Term("Nominal",Schema.List(true,Schema.String,Schema.Any)), Schema.Term("Or",Schema.Set(true,Schema.Any)), Schema.Term("And",Schema.Set(true,Schema.Any)), Schema.Term("Set",Schema.List(true,Schema.Bool,Schema.Set(true,Schema.Any))), Schema.Term("Bag",Schema.List(true,Schema.Bool,Schema.Bag(true,Schema.Any))), Schema.Term("List",Schema.List(true,Schema.Bool,Schema.List(true,Schema.Any)))))),
		// Or(^({^($9<Not(^($17<Any|Void|Bool|Int|Real|String>))|$17|Not(^($9))|Ref(^($9))|Meta(^($9))|Nominal(^([^(string),^($9)]))|Or(^({^($9)...}))|And(^({^($9)...}))|Set(^([^(bool),^({^($9)...})]))|Bag(^([^(bool),^({|^($9)...|})]))|List(^([^(bool),^([^($9)...])]))>)...}))
		Schema.Term("Or",Schema.Set(true,Schema.Or(Schema.Or(Schema.Term("Not",Schema.Or(Schema.Term("Any"), Schema.Term("Void"), Schema.Term("Bool"), Schema.Term("Int"), Schema.Term("Real"), Schema.Term("String"))), Schema.Any), Schema.Term("Not",Schema.Any), Schema.Term("Ref",Schema.Any), Schema.Term("Meta",Schema.Any), Schema.Term("Nominal",Schema.List(true,Schema.String,Schema.Any)), Schema.Term("Or",Schema.Set(true,Schema.Any)), Schema.Term("And",Schema.Set(true,Schema.Any)), Schema.Term("Set",Schema.List(true,Schema.Bool,Schema.Set(true,Schema.Any))), Schema.Term("Bag",Schema.List(true,Schema.Bool,Schema.Bag(true,Schema.Any))), Schema.Term("List",Schema.List(true,Schema.Bool,Schema.List(true,Schema.Any)))))),
		// Any
		Schema.Term("Any"),
		// Void
		...
		// String
		Schema.Term("String"),
		// Ref(^($4<Not(^($12<Any|Void|Bool|Int|Real|String>))|$12|Not(^($4))|Ref(^($4))|Meta(^($4))|Nominal(^([^(string),^($4)]))|Or(^({^($4)...}))|And(^({^($4)...}))|Set(^([^(bool),^({^($4)...})]))|Bag(^([^(bool),^({|^($4)...|})]))|List(^([^(bool),^([^($4)...])]))>))
		Schema.Term("Ref",Schema.Or(Schema.Or(Schema.Term("Not",Schema.Or(Schema.Term("Any"), Schema.Term("Void"), Schema.Term("Bool"), Schema.Term("Int"), Schema.Term("Real"), Schema.Term("String"))), Schema.Any), Schema.Term("Not",Schema.Any), Schema.Term("Ref",Schema.Any), Schema.Term("Meta",Schema.Any), Schema.Term("Nominal",Schema.List(true,Schema.String,Schema.Any)), Schema.Term("Or",Schema.Set(true,Schema.Any)), Schema.Term("And",Schema.Set(true,Schema.Any)), Schema.Term("Set",Schema.List(true,Schema.Bool,Schema.Set(true,Schema.Any))), Schema.Term("Bag",Schema.List(true,Schema.Bool,Schema.Bag(true,Schema.Any))), Schema.Term("List",Schema.List(true,Schema.Bool,Schema.List(true,Schema.Any))))),
		// Meta(^($4<Not(^($12<Any|Void|Bool|Int|Real|String>))|$12|Not(^($4))|Ref(^($4))|Meta(^($4))|Nominal(^([^(string),^($4)]))|Or(^({^($4)...}))|And(^({^($4)...}))|Set(^([^(bool),^({^($4)...})]))|Bag(^([^(bool),^({|^($4)...|})]))|List(^([^(bool),^([^($4)...])]))>))
		Schema.Term("Meta",Schema.Or(Schema.Or(Schema.Term("Not",Schema.Or(Schema.Term("Any"), Schema.Term("Void"), Schema.Term("Bool"), Schema.Term("Int"), Schema.Term("Real"), Schema.Term("String"))), Schema.Any), Schema.Term("Not",Schema.Any), Schema.Term("Ref",Schema.Any), Schema.Term("Meta",Schema.Any), Schema.Term("Nominal",Schema.List(true,Schema.String,Schema.Any)), Schema.Term("Or",Schema.Set(true,Schema.Any)), Schema.Term("And",Schema.Set(true,Schema.Any)), Schema.Term("Set",Schema.List(true,Schema.Bool,Schema.Set(true,Schema.Any))), Schema.Term("Bag",Schema.List(true,Schema.Bool,Schema.Bag(true,Schema.Any))), Schema.Term("List",Schema.List(true,Schema.Bool,Schema.List(true,Schema.Any))))),
		// Term(^([^(string),^($10<Not(^($18<Any|Void|Bool|Int|Real|String>))|$18|Not(^($10))|Ref(^($10))|Meta(^($10))|Nominal(^([^(string),^($10)]))|Or(^({^($10)...}))|And(^({^($10)...}))|Set(^([^(bool),^({^($10)...})]))|Bag(^([^(bool),^({|^($10)...|})]))|List(^([^(bool),^([^($10)...])]))>)]))
		Schema.Term("Term",Schema.List(true,Schema.String,Schema.Or(Schema.Or(Schema.Term("Not",Schema.Or(Schema.Term("Any"), Schema.Term("Void"), Schema.Term("Bool"), Schema.Term("Int"), Schema.Term("Real"), Schema.Term("String"))), Schema.Any), Schema.Term("Not",Schema.Any), Schema.Term("Ref",Schema.Any), Schema.Term("Meta",Schema.Any), Schema.Term("Nominal",Schema.List(true,Schema.String,Schema.Any)), Schema.Term("Or",Schema.Set(true,Schema.Any)), Schema.Term("And",Schema.Set(true,Schema.Any)), Schema.Term("Set",Schema.List(true,Schema.Bool,Schema.Set(true,Schema.Any))), Schema.Term("Bag",Schema.List(true,Schema.Bool,Schema.Bag(true,Schema.Any))), Schema.Term("List",Schema.List(true,Schema.Bool,Schema.List(true,Schema.Any)))))),
		// Nominal(^([^(string),^($10<Not(^($18<Any|Void|Bool|Int|Real|String>))|$18|Not(^($10))|Ref(^($10))|Meta(^($10))|Nominal(^([^(string),^($10)]))|Or(^({^($10)...}))|And(^({^($10)...}))|Set(^([^(bool),^({^($10)...})]))|Bag(^([^(bool),^({|^($10)...|})]))|List(^([^(bool),^([^($10)...])]))>)]))
		Schema.Term("Nominal",Schema.List(true,Schema.String,Schema.Or(Schema.Or(Schema.Term("Not",Schema.Or(Schema.Term("Any"), Schema.Term("Void"), Schema.Term("Bool"), Schema.Term("Int"), Schema.Term("Real"), Schema.Term("String"))), Schema.Any), Schema.Term("Not",Schema.Any), Schema.Term("Ref",Schema.Any), Schema.Term("Meta",Schema.Any), Schema.Term("Nominal",Schema.List(true,Schema.String,Schema.Any)), Schema.Term("Or",Schema.Set(true,Schema.Any)), Schema.Term("And",Schema.Set(true,Schema.Any)), Schema.Term("Set",Schema.List(true,Schema.Bool,Schema.Set(true,Schema.Any))), Schema.Term("Bag",Schema.List(true,Schema.Bool,Schema.Bag(true,Schema.Any))), Schema.Term("List",Schema.List(true,Schema.Bool,Schema.List(true,Schema.Any)))))),
		// Fun(^([^($10<Not(^($18<Any|Void|Bool|Int|Real|String>))|$18|Not(^($10))|Ref(^($10))|Meta(^($10))|Nominal(^([^(string),^($10)]))|Or(^({^($10)...}))|And(^({^($10)...}))|Set(^([^(bool),^({^($10)...})]))|Bag(^([^(bool),^({|^($10)...|})]))|List(^([^(bool),^([^($10)...])]))>),^($10)]))
		...
		// Set(^([^(bool),^({^($15<Not(^($23<Any|Void|Bool|Int|Real|String>))|$23|Not(^($15))|Ref(^($15))|Meta(^($15))|Nominal(^([^(string),^($15)]))|Or(^({^($15)...}))|And(^({^($15)...}))|Set(^([^(bool),^({^($15)...})]))|Bag(^([^(bool),^({|^($15)...|})]))|List(^([^(bool),^([^($15)...])]))>)...})]))
		Schema.Term("Set",Schema.List(true,Schema.Bool,Schema.Set(true,Schema.Or(Schema.Or(Schema.Term("Not",Schema.Or(Schema.Term("Any"), Schema.Term("Void"), Schema.Term("Bool"), Schema.Term("Int"), Schema.Term("Real"), Schema.Term("String"))), Schema.Any), Schema.Term("Not",Schema.Any), Schema.Term("Ref",Schema.Any), Schema.Term("Meta",Schema.Any), Schema.Term("Nominal",Schema.List(true,Schema.String,Schema.Any)), Schema.Term("Or",Schema.Set(true,Schema.Any)), Schema.Term("And",Schema.Set(true,Schema.Any)), Schema.Term("Set",Schema.List(true,Schema.Bool,Schema.Set(true,Schema.Any))), Schema.Term("Bag",Schema.List(true,Schema.Bool,Schema.Bag(true,Schema.Any))), Schema.Term("List",Schema.List(true,Schema.Bool,Schema.List(true,Schema.Any))))))),
		// Bag(^([^(bool),^({|^($15<Not(^($23<Any|Void|Bool|Int|Real|String>))|$23|Not(^($15))|Ref(^($15))|Meta(^($15))|Nominal(^([^(string),^($15)]))|Or(^({^($15)...}))|And(^({^($15)...}))|Set(^([^(bool),^({^($15)...})]))|Bag(^([^(bool),^({|^($15)...|})]))|List(^([^(bool),^([^($15)...])]))>)...|})]))
		Schema.Term("Bag",Schema.List(true,Schema.Bool,Schema.Bag(true,Schema.Or(Schema.Or(Schema.Term("Not",Schema.Or(Schema.Term("Any"), Schema.Term("Void"), Schema.Term("Bool"), Schema.Term("Int"), Schema.Term("Real"), Schema.Term("String"))), Schema.Any), Schema.Term("Not",Schema.Any), Schema.Term("Ref",Schema.Any), Schema.Term("Meta",Schema.Any), Schema.Term("Nominal",Schema.List(true,Schema.String,Schema.Any)), Schema.Term("Or",Schema.Set(true,Schema.Any)), Schema.Term("And",Schema.Set(true,Schema.Any)), Schema.Term("Set",Schema.List(true,Schema.Bool,Schema.Set(true,Schema.Any))), Schema.Term("Bag",Schema.List(true,Schema.Bool,Schema.Bag(true,Schema.Any))), Schema.Term("List",Schema.List(true,Schema.Bool,Schema.List(true,Schema.Any))))))),
		// List(^([^(bool),^([^($15<Not(^($23<Any|Void|Bool|Int|Real|String>))|$23|Not(^($15))|Ref(^($15))|Meta(^($15))|Nominal(^([^(string),^($15)]))|Or(^({^($15)...}))|And(^({^($15)...}))|Set(^([^(bool),^({^($15)...})]))|Bag(^([^(bool),^({|^($15)...|})]))|List(^([^(bool),^([^($15)...])]))>)...])]))
