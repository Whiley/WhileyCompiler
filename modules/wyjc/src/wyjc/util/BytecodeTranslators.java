...
public class BytecodeTranslators {
	...
	private static final class Dereference implements BytecodeTranslator {
		@Override
		public void translate(SyntaxTree.Operator<Operator> expr, Context context) throws ResolveError {
	...
	private static final class LogicalNot implements BytecodeTranslator {
		@Override
		public void translate(SyntaxTree.Operator<Operator> expr, Context context) {
