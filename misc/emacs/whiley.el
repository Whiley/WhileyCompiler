...
(defvar whiley-keywords
  '("process" "extern" "null" "return" "if" "throw" "throws" "switch" "case" "default" "break" "skip" "while" "for" "else" "define" "assert" "as" "package" "import" "debug" "where" "ensures" "requires" "public" "visible" "this" "str" "spawn" "in" "no" "some" "false" "true")
    "Whiley keywords.")
