...
(defvar whiley-keywords
  '("process" "native" "extern" "null" "return" "if" "is" "throw" "throws" "switch" "case" "default" "break" "skip" "while" "for" "else" "define" "assert" "as" "package" "import" "debug" "where" "ensures" "requires" "public" "protected" "private" "export" "this" "str" "spawn" "in" "no" "some" "false" "true")
    "Whiley keywords.")
