...
(defvar whiley-keywords
  '("process" "extern" "null" "return" "if" "while" "for" "else" "define" "assert" "as" "package" "import" "print" "where" "ensures" "requires" "public" "visible" "this" "str" "spawn" "in" "no" "some" "false" "true")
    "Whiley keywords.")
