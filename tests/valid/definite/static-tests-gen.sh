...
echo ""
echo "public class DefiniteStaticValidTests extends TestHarness {"
echo " public DefiniteStaticValidTests() {"
echo "  super(\"tests/valid/definite\",\"tests/valid/definite\",\"sysout\");"
echo " }"
echo ""
...
do
    ...
    echo "_StaticTest() { verificationRunTest(\"$nf\"); }"
done
