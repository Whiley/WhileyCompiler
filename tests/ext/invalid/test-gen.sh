...
echo ""
echo "public class ExtendedRuntimeInvalidTests extends TestHarness {"
echo " public ExtendedRuntimeInvalidTests() {"
echo "  super(\"tests/ext/invalid\",\"tests/ext/invalid\",\"sysout\");"
echo " }"
echo ""
...
do
    ...
    echo "_RuntimeFailTest() { runtimeFailTest(\"$nf\"); }"
done
