...
echo ""
echo "public class DefiniteStaticInvalidTests extends TestHarness {"
echo " public DefiniteStaticInvalidTests() {"
echo "  super(\"tests/invalid/definite\",\"tests/invalid/definite\",\"sysout\");"
echo " }"
echo ""
...
do
    ...
    echo "_StaticTest() { verificationFailTest(\"$nf\"); }"
done
